...
#        self.arduino_I2C = serial.Serial('COM9', baudrate = 9600, timeout = 1)
    ...
    def run(self, order_temperature=40, ):
...
#            self.real_temperature = getValues(self.arduino_I2C, self.application.regulation_fonction_output)
            ...
            self.order_temperature = self.tk_root.input_temperatures.order_temperature_plot + self.temperature_compensation   # accède à la order_temperature
